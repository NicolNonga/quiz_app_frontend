...
export class RoutingService {
    public onChange: BehaviorSubject<Paths> = new BehaviorSubject<Paths>([]);
    public events: BehaviorSubject<RouterEvent | null> = new BehaviorSubject<RouterEvent | null>(null);
     ...
     * @return [description]
     */
    private static createBreadcrumb(route: ActivatedRouteSnapshot, url: string | any): Path {
        let isUrl = true;
    ...
    private init(): void {
        this.router.events.subscribe(routeEvent => {
            ...
            if (routeEvent instanceof NavigationEnd) {
                ...
                let route: any = this.router?.routerState?.root?.snapshot,
                    tmpUrl = '',
                    url = '',
                    rootRoot = true;
